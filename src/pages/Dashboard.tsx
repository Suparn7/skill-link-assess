            ...
            <Card className="glass-card">
              ...
              <CardContent>
                <div className="space-y-4">
                  <Progress value={getProfileCompletionPercentage()} className="w-full" />
                  <p className="text-sm text-muted-foreground">
                    {getProfileCompletionPercentage().toFixed(0)}% Complete
                  </p>
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm">Documents Upload</span>
                    </div>
                  </div>
                  {!userData.personalInfo && (
                    <Button 
